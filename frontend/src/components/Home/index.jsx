            ...
            <div>
              <div className="faq-section">
                ...
                <FontAwesomeIcon icon={faPlus}
                                 className={activeSections.event ? `question-icon rotate` : `question-icon`} />
              </div>
              <div className={activeSections.event ? `accordion-content answer-divider` : `accordion-content`}
                ...
                <p>La ceremonia será el 5 de Octubre de 2024 a las 18:00. Después pasaremos al cocktail, la cena y el
                  baile.</p>
          ...
          <button className={`accordion-button ${activeSections.information ? 'active' : ''}`}
            ...
            <div>
              <div className="faq-section">
                ...
                <FontAwesomeIcon icon={faPlus}
                                 className={activeSections.information ? `question-icon rotate` : `question-icon`} />
              </div>
              <div className={activeSections.information ? `accordion-content answer-divider` : `accordion-content`}
                ...
                <p>En la propia finca hay disponible alojamiento (bungalows). Hay más información en <Link
                ...
                <p>Los precios los tenéis disponibles <a href={preciosPDF} target="_blank"
                                                         rel="noopener noreferrer">aquí</a>.</p>              <h3
                className="h3-home">Planes de domingo</h3>
